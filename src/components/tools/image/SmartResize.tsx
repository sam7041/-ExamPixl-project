        ...
        <div className="lg:col-span-8 space-y-6">
          {!file ? (
            ...
            >
              ...
              <div className="relative flex flex-col items-center justify-center min-h-[450px] rounded-3xl border-2 border-dashed border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all p-12 text-center">
                <input
                  type="file"
                  ref={fileInputRef}
                  className="hidden"
                ...
                />
                <div className="h-24 w-24 bg-brand-50 dark:bg-brand-900/20 rounded-2xl flex items-center justify-center text-brand-600 dark:text-brand-400 mb-8 group-hover:scale-110 transition-transform">
                  <Upload size={40} />
                </div>
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Drop your image here</h3>
